              ...
              <section className={styles.secondSection}>
                ...
                <section className={styles.referral}>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    required
                    placeholder={studentCount && isAdmin ? studentCount:"e.g. https://game.everdawn.io/......"}
                  />
                  <h1 style={{color:"white", fontSize: "clamp(0.7rem, 1vw, 1.2rem)", fontFamily:"monospace", margin:"0"}}>Go to: Everdrawn profile &rarr; settings &rarr; referral </h1>
                </section>
              </section>
              <br />
